...
def register():
    ...
    if not name or not age or not email:
        messagebox.showerror("inpuwt erawrrr", "thika muchkond yella fill madu boli magane <3.")
        return
...
gender_helikopter = tk.Radiobutton(root, text="Helikopter", variable=gender_var, value="Helikopter")
gender_helikopter.grid(row=2, column=1, padx=130, pady=5, sticky="w")
